...
const PARTY = {
 ...
 "curators": [
  {
   "key": "www",
   "name": "📖 WWW Guide",
   "title": "The official What Where When",
   "tagline": "every food & tea event in Black Rock City — 234 kitchens + 326 tea houses, sorted by distance from our door",
   "kind": "timed"
  },
  {
   "key": "camp",
 ...
 "ideas": [
  {
   "title": "✅ THE WWW GUIDE IS IN THE MACHINE",
   "dream": "Found the full official export online (blessed by BM Innovate) — every food & tea event now lives on this board with distances. Fresher pull lands when the official API key arrives.",
   "needs": [],
   "by": "sysadmin 🫡",
   "status": "done"
  },

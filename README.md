...
**Running a camp? Steal this.** Turtle Ops is the open-source camp-ops
hub of Terrible Turtle Camp (Burning Man) — and the home of the **Camp
Agent Kit**: everything you need to raise *a campmate who never forgets
and never sleeps* for your own camp, in about five minutes, on tools you
already have.

**Live hub:** https://terribleturtle.camp/ · **Start here:** [`agent-kit/START-HERE.md`](agent-kit/START-HERE.md)
...
## Steal this — it's CC0, we mean it

Everything in this repo is **CC0 public domain**. No permission, no
attribution, no strings. Fork it like crazy, gift it forward.
